        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyServices_Companies_Company_Id",
                        column: x => x.Company_Id,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyServices_Services_Service_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Company_Service_Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ServicePrice = table.Column<double>(type: "float", nullable: false),
                    Payment_Method = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Endurance_Ratio = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Created_By = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Create_Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Last_Modified_By = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Last_Modify_Date = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientServices_Clients_Client_Id",
                        column: x => x.Client_Id,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientServices_CompanyServices_Company_Service_Id",
                        column: x => x.Company_Service_Id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientServices_Client_Id",
                table: "ClientServices",
                column: "Client_Id");

            migrationBuilder.CreateIndex(
                name: "IX_ClientServices_Company_Service_Id",
                table: "ClientServices",
                column: "Company_Service_Id");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyServices_Company_Id",
                table: "CompanyServices",
                column: "Company_Id");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyServices_Service_Id",
                table: "CompanyServices",
                column: "Service_Id");
        }
